...
#include "../App_QML/translatormanager.h"
...
QT_MOC_LITERAL(3, 35, 14), // "switchLanguage"
QT_MOC_LITERAL(4, 50, 8) // "language"

    },
    "TranslatorManager\0languageChanged\0\0"
...
void TranslatorManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->switchLanguage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TranslatorManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TranslatorManager::languageChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TranslatorManager::languageChanged()
{
